...
**Program**: MSc in Engineering in Computer Science and AI  
...
This repository contains academic coursework. Datasets are sourced from the **UCI Machine Learning Repository** under their respective licenses. Code implementations are original work by Nicolas Leone.
...
- I-C. Yeh. *Concrete Compressive Strength*. UCI Machine Learning Repository, 2007.
